...
class Net(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.b1 = nn.Sequential(*[ops.ResidualBlock(64, 64) for _ in range(3)])
        self.b2 = nn.Sequential(*[ops.ResidualBlock(64, 64) for _ in range(3)])
        self.b3 = nn.Sequential(*[ops.ResidualBlock(64, 64) for _ in range(3)])
