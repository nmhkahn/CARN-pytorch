scale=2
ckpt_path="model/Base-64W-96S.pth"
model="base"
...
python src/sample.py --model=$model --ckpt_path=$ckpt_path --sample_dir=sample/ --test_data_dir=dataset/DIV2K_valid --cuda --scale=$scale
